...
class Collater:
    ...
    def __call__(self, batch):
        ...
        # ZERO PADDING NEEDS TO HAPPEN HERE.
        batch = Batch.from_data_list(batch)

        # Reshape features.
        batch.x = batch.x.reshape(
            batch._num_graphs,
            *sample.x.shape,  # NEEDS TO BE CONSISTENT OVER ALL GRAPHS. ANY ZERO-PADDING NEEDS TO HAPPEN BEFORE.
        )
...
class ModelNet40DataModule(pl.LightningDataModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.data_dir = utils.get_original_cwd() + data_dir + "/ModelNet40"
        ...
        # Create transform
        self.pre_transform = pyg_transforms.Compose(
            [
...
# To support direct addition of batch features, we hack the shit out of the databatch object.
